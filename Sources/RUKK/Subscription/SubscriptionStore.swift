...
final class SubscriptionStore {
    ...
    /// Á þessi notandi rétt á fría reynslutímanum? (Reynslutími er einu sinni per Apple ID;
    /// endurkomandi notendur eru rukkaðir strax — þá á ekki að lofa „frítt í viku".)
    ...
    func load() async {
        ...
        // Reynsluréttur er metinn út frá kaupasögu Apple ID-sins (async).
